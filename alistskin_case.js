...
flower_header_append_code += `<h3>DANIAO.MEN</h3>`; 
flower_header_append_code += `<div class="flower_header_self_headimg">`; 
flower_header_append_code += `<img src="https://cdn.jsdelivr.net/gh/maxiaoku/IMG@main/LOGO-DANIAO.svg">`; 
flower_header_append_code += `</div>`; 
flower_header_append_code += `</div>`; 
flower_header_append_code += `<div class="flower_header_dictum">`; 
flower_header_append_code += `<p>免费同志资源目录</p>`; 
flower_header_append_code += `<h4>DANIAO</h4>`; 
flower_header_append_code += `</div>`; 
...
flower_header_append_code += `<li><a href="https://t.me/+ht2PUp1bVKA4YWYx" target="_blank">TG群组</a></li>`; 
flower_header_append_code += `<li><a href="https://t.me/DANIAOMEN" target="_blank">联系我</a></li>`; 
...
flower_footer_append_code += `<a class="flower_footer_codea" href="/"  >DANIAO.MEN</a>`; 
